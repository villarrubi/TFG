...
| Demostración en directo | Existe un recorrido de demostración, EML controlados, capturas y plan B sin secretos. Las guías personales se conservan solo en local. | `defense_demo/README.md` |
| Declarar el uso de IA | Se menciona de forma breve en la metodología como apoyo técnico, se mantiene la responsabilidad del autor y se excluye la IA como fuente académica. | Metodología de la memoria |
