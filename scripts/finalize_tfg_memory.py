...
def correct_project_sections(doc) -> None:
    ...
    for paragraph in _paragraphs(doc):
        ...
        paragraph.text = paragraph.text.replace(
            ...
            "la versión revisada ejecuta 81 pruebas Python y 2 de navegador",
        )
        paragraph.text = paragraph.text.replace(
            "correctamente 44 pruebas",
            "correctamente 81 pruebas Python y 2 de navegador",
        )
        paragraph.text = paragraph.text.replace(
        ...
        paragraph.text = paragraph.text.replace(
            ...
            "La suite de 81 pruebas Python y 2 de navegador",
        )
        paragraph.text = paragraph.text.replace(
        ...
        paragraph.text = paragraph.text.replace(
            ...
            "suite de 81 pruebas Python y 2 de navegador",
        )
