...
def main():
    ...
    replacements = {
        ...
        "41 pruebas unitarias y de integración": "87 pruebas unitarias y de integración",
        "41 pruebas unitarias y de integración mediante unittest": "87 pruebas unitarias y de integración mediante unittest",
        "41 pruebas automatizadas": "87 pruebas automatizadas",
        "contiene 41 pruebas.": "contiene 87 pruebas.",
    ...
    add_para(doc, "La suite se ejecuta con python -m unittest discover -s tests -p \"test_*.py\" y contiene 87 pruebas. También se ejecuta python -m ruff check src tests scripts browser_tests, que finaliza sin errores estáticos. Las advertencias de convergencia observadas pertenecen únicamente a pruebas deliberadamente configuradas con 20 iteraciones para comprobar el flujo rápido.")
